...
namespace Joy\VoyagerBreadProjectTask\Models;
...
use Joy\VoyagerBreadProjectTask\Database\Factories\ProjectTaskFactory;
...
class ProjectTask extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('ProjectTask'));
    }
